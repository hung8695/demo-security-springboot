...
public class AdminPrincipal implements UserDetails {
    ...
    public AdminPrincipal(Long id, String name, String password, Collection<? extends GrantedAuthority> types) {
        this.id = id;
        this.name = name;
        this.password = password;
        this.types = types;
    }
    public static AdminPrincipal build(Admin admin) {
    ...
    public boolean equals(Object o) {
        ...
        AdminPrincipal adminPrinciple = (AdminPrincipal) o;
